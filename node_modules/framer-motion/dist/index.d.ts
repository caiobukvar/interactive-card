...
declare type StepId = "read" | "update" | "postUpdate" | "preRender" | "render" | "postRender";
declare type Sync = {
 ...
 */
declare function buildTransform({ transform, transformKeys, }: Pick<HTMLRenderState, "transform" | "transformKeys">, { enableHardwareAcceleration, allowTransformNone, }: DOMVisualElementOptions, transformIsDefault: boolean, transformTemplate?: MotionProps["transformTemplate"]): string;
 ...
 */
declare function spring({ keyframes, restDelta, restSpeed, ...options }: AnimationOptions<number>): Animation$1<number>;
